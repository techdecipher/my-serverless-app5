...
```bash
my-serverless-app5$ make build
my-serverless-app5$ make deploy.guided
```
...
```bash
my-serverless-app5$ make invoke
```
...
```bash
my-serverless-app5$ make run
my-serverless-app5$ curl http://localhost:3000/hello
```
...
```bash
my-serverless-app5$ sam logs -n HelloWorldFunction --stack-name <Name-of-your-deployed-stack> --tail
```
...
```bash
my-serverless-app5$ make dev
my-serverless-app5$ make test
```
...
```bash
my-serverless-app5$ aws cloudformation delete-stack --stack-name my-serverless-app5
```
...
```bash
my-serverless-app5$ pipenv lock -r > hello_world/requirements.txt
```
